<template>
    ...
    <div class="position-relative d-flex align-items-center
     justify-content-center mt-5" style="min-height: 300px;">
              ...
              <div class="card-header px-0 py-4 bg-white border border-bottom-0
               border-top border-start-0 border-end-0 rounded-0" id="headingOne"
                ...
                <div class="d-flex justify-content-between align-items-center pe-1">
                  <h4 class="mb-0 justify-content-center"
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
               data-bs-parent="#accordionExample">
                <div class="card-body py-0">
                  ...
                  <li><RouterLink class="py-2 d-block text-muted text-decoration-none"
                       :to="`/products`">
                       全部
                    </RouterLink></li>
                   <li v-for="item in categories" :key="item">
                      <RouterLink class="py-2 d-block text-muted text-decoration-none"
                       style="color: #3F705D;"
          ...
          <div class="row">
            <div class="col-md-6" v-for="item in products" :key="item.id">
              ...
              <div class="card border-0 mb-4 position-relative position-relative">
                ...
                height="294" class="card-img-top rounded-0 object-fit-cover" alt="...">
                ...
                <div class="card-body p-0">
                  <h4 class="mb-0 mt-3 fw-bold" style="color: #4e342e;">
                    ...
                    <small><span class="text-muted ">
                      <del>NT${{ item.origin_price }}</del></span></small>
