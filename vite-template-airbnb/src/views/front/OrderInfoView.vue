          ...
          <div class="col-md-6">
            <div class="bg-white p-4">
              ...
              <form>
                <div class="mb-2">
                  ...
                  <input type="email" class="form-control rounded-0" id="ContactMail"
                ...
                <div class="mb-2">
                  ...
                  <input type="text" class="form-control rounded-0" id="ContactName"
                   placeholder="Carmen A. Rose">
                </div>
                <div class="">
                  <label for="ContactPhone" class="text-muted mb-0 form-label">Phone</label>
                  <input type="text" class="form-control rounded-0" id="ContactPhone"
            ...
            <div class="bg-white p-4 mt-3">
              ...
              <form>
                ...
                <input type="text" class="form-control rounded-0 mt-1" id="inputCity"
                 placeholder="Address">
