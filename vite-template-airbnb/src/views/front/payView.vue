      ...
      <div class="row flex-row-reverse justify-content-center pb-5">
        ...
        <div class="col-md-6">
          <div class="accordion" id="accordionExample">
               ...
               data-bs-parent="#accordionExample">
                <div class="card-body bg-light ps-5 py-4">
                  <div class="mb-2">
                    ...
                    <input type="text" class="form-control" id="Lorem ipsum1"
                     placeholder="Lorem ipsum">
                  </div>
                  <div class="mb-0">
                    <label for="Lorem ipsum2" class="text-muted mb-0">Lorem ipsum</label>
                    <input type="text" class="form-control" id="Lorem ipsum2"
                     placeholder="Lorem ipsum">
                  </div>
                </div>
              </div>
            ...
            <div class="card rounded-0">
              <div class="card-header bg-white border-0 py-3 collapsed"
                ...
                <div class="card-body bg-light ps-5 py-4">
                  <div class="mb-2">
                    ...
                    <input type="text" class="form-control"
                     id="Lorem ipsum1" placeholder="Lorem ipsum">
                  </div>
                  <div class="mb-0">
                    <label for="Lorem ipsum2" class="text-muted mb-0">Lorem ipsum</label>
                    <input type="text" class="form-control" id="Lorem ipsum2"
          ...
          <div class="d-flex flex-column-reverse flex-md-row mt-4 justify-content-between
           align-items-md-center align-items-end w-100">
            ...
            <button type="submit" class="btn btn-dark py-3 px-7">
                  <RouterLink to="/checkoutSuccess">確認付款</RouterLink></button>
          </div>
        </div>
      </div>
</template>
