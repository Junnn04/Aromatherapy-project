  ...
  <div class="row flex-row-reverse justify-content-center pb-5">
    <div class="col-md-4">
      <div class="border p-4 mb-4">
        <div class="d-flex" v-for="item in order" :key="item.id">
          <img :src="item.product.imageUrl" alt="商品圖片" class="me-2"
        ...
        <table class="table mt-4 border-top border-bottom text-muted">
          <tbody>
            ...
            <tr>
              ...
              <td class="text-end border-0 px-0 pt-4">NT${{ order.final_total-order.total }}</td>
            </tr>
            <tr>
    ...
    <div class="col-md-6">
      ...
      <div class="accordion" id="accordionExample">
        <div class="card rounded-0">
          <div class="card-header bg-white border-0 py-3" id="headingOne"
           data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true"
            ...
            <p class="mb-0 position-relative custom-checkout-label">信用卡付款</p>
          </div>
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
           data-bs-parent="#accordionExample">
            <div class="card-body bg-light ps-5 py-4">
              <div class="mb-2">
                <label for="Lorem ipsum1" class="text-muted mb-0">信用卡號</label>
                      <VField type="text" class="form-control" id="creditCardNum" name="creditCard"
                      placeholder="xxxx xxxx xxxx xxxx" rules="required|credit_card"
                      :class="{ 'is-invalid': errors['creditCard'] }"></VField>
                    <error-message name="creditCard" class="invalid-feedback"></error-message>
              </div>
              <div class="mb-0">
                <label for="Lorem ipsum2" class="text-muted mb-0">檢查碼</label>
                      <VField type="text" class="form-control" id="checkNum"
                     placeholder="xxx" rules="required|min:3|max:3"
                  :class="{ 'is-invalid': errors['checkNum'] }" name="checkNum"></VField>
                  <error-message name="checkNum" class="invalid-feedback"></error-message>
              </div>
            </div>
          </div>
        </div>
        <div class="card rounded-0">
          <div class="card-header bg-white border-0 py-3 collapsed" id="headingTwo"
           data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true"
            aria-controls="collapseTwo">
            <p class="mb-0 position-relative custom-checkout-label">WebATM</p>
          </div>
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
           data-bs-parent="#accordionExample">
            <div class="card-body bg-light ps-5 py-4">
              ...
              <div class="mb-0">
                <label for="Lorem ipsum2" class="text-muted mb-0">ApplePay</label>
        ...
        <div class="card rounded-0">
          <div class="card-header bg-white border-0 py-3 collapsed" id="headingThree"
           data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true"
            aria-controls="collapseThree">
            <p class="mb-0 position-relative custom-checkout-label">ApplePay</p>
          </div>
      ...
      <div class="d-flex flex-column-reverse flex-md-row mt-4 justify-content-between
       align-items-md-center align-items-end w-100">
          ...
          style="background-color: #7FA185;">確認付款</button>
      </div>
    </VForm>
    </div>
  </div>
